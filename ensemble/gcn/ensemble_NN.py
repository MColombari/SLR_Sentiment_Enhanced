...
EXP_NUMBER = '24100C' # Epoch number

LOAD_MODEL_WEIGHT_PATH = "/work/cvcs2024/SLR_sentiment_enhanced/SLRSE_model_data/Ensemble/Ensemble_NN/weights/Exp19100C.pt"
...
model = MLP(num_fin, num_classes).to(device)
