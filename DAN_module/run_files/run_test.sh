...
python gen_emotion.py \
    --video_folder /work/cvcs2024/SLR_sentiment_enhanced/datasets/custom/raw_video \
    --npy_folder /work/cvcs2024/SLR_sentiment_enhanced/SLRSE_model_data/data-prepare/demo/custom_dataset_npy \
    --out_file /work/cvcs2024/SLR_sentiment_enhanced/DAN/results/custom.csv \